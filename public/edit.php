...
?>
        ...
        <form class="row needs-validation" action="edit.php" method="post" novalidate>
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="validationCustom01" name="nim" value="<?php echo $nim;?>"
                    required>
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="validationCustom02" name="nama" value="<?php echo $nama;?>"
                    required>
                <div class="valid-feedback">
                    Looks good!
                </div>
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="validationCustom03" name="jenis_kelamin"
                    value="<?php echo $jenis_kelamin;?>" required>
                <div class="valid-feedback">
                    Looks good!
                </div>
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="validationCustom04" name="tempat_lahir"
            ...
            <div class="col-md-12">
                ...
                <input type="text" class="form-control" id="validationCustom05" name="tanggal_lahir"
            ...
            <div class="col-md-12">
                ...
                <textarea class="form-control" id="validationCustom06" name="alamat"
