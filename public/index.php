    ...
    <div class="col-lg-11 col-xxl-4 my-5 mx-auto">
        ...
        ?>
                    <tr>
                        ...
                        <td><a class="btn btn-small btn-warning" href="./edit.php"><i class="bi bi-pencil-square"></i>
                                Ubah</a> |
                            <a class="btn btn-small btn-danger" href="./hapus.php"><i class="bi bi-trash"></i> Hapus</a>
                        </td>
                    </tr>
                    <?php
                }
